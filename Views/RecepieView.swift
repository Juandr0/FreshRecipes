...
struct RecepieView: View {
    ...
    var body: some View {
        NavigationView {
            VStack{
                ItemFilterView(filterListExcluded : $filterListExcluded)
                
                ItemReciptListView(db: db,
                                   recepies: recepies,
                                   searchQuery: $searchQuery,
                                   filterQuery: $filterQuery,
                                   filterListExcluded: $filterListExcluded)
            }
        }
    }
...
struct ItemFilterView : View {
    ...
    @State var filterQuery = ""
    @State var isFilterViewCollapsed = true
    @Binding var filterListExcluded : [String]
...
struct ItemReciptListView  : View {
    let db : Firestore
    @ObservedObject var recepies : RecepiesList
